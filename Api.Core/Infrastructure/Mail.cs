...
namespace Api.Core.Infrastructure
{
    ...
    {
        public static bool SendEmail(string to, string subject, string body, bool isBodyHtml = false, string from = null, IList<CustomFileBase> actualFiles = null, string name = null)
        {
