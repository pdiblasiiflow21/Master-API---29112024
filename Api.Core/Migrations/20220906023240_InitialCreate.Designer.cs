...
namespace Api.Core.Migrations
{
    ...
    [Migration("20220906023240_InitialCreate")]
            ...
            modelBuilder.Entity("Api.Core.Entities.CondicionPago", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Nombre = "A 30 días FF"
                        },
                        new
                        {
                            Id = 2,
                            Nombre = "A 45 días FF"
                        },
                        new
                        {
                            Id = 3,
                            Nombre = "A 60 días FF"
                        });
                });
            ...
            modelBuilder.Entity("Api.Core.Entities.DetalleLiquidacionPos", b =>
                {
                    ...
                    b.Property<decimal>("CostoEnvioReal")
                        .HasColumnType("decimal(65,30)");

                    b.Property<decimal>("CostoEnvioTarifado")
                        .HasColumnType("decimal(65,30)");
            ...
            modelBuilder.Entity("Api.Core.Entities.DetalleLiquidacionPre", b =>
                {
                    ...
                    b.Property<string>("CallbackasociadoMP")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");
                    ...
                    b.Property<int>("IdMercadoPago")
                        .HasColumnType("int");

                    b.Property<int>("IdOrdenPago")
                        .HasColumnType("int");

                    b.Property<int>("IdPreferenciaMP")
                        .HasColumnType("int");
