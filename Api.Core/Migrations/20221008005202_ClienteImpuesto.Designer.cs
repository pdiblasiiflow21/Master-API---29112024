...
namespace Api.Core.Migrations
{
    ...
    [Migration("20221008005202_ClienteImpuesto")]
    partial class ClienteImpuesto
    {
            ...
            modelBuilder.Entity("Api.Core.Entities.ClienteImpuesto", b =>
                {
                    ...
                    b.Property<int>("ErpMilongaTaxTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ErpMilongaTaxTypeId");
            ...
            modelBuilder.Entity("Api.Core.Entities.ClienteImpuesto", b =>
                {
                    ...
                    b.HasOne("Api.Core.Entities.ErpMilongaTaxType", "ErpMilongaTaxType")
                        .WithMany()
                        .HasForeignKey("ErpMilongaTaxTypeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
