...
namespace Api.Core.Migrations
{
    ...
    [Migration("20221009012520_ImpuestosUpdate")]
    partial class ImpuestosUpdate
    {
            ...
            modelBuilder.Entity("Api.Core.Entities.ClienteImpuesto", b =>
                {
                    ...
                    b.Property<int>("ErpMilongaTaxCodeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ErpMilongaTaxCodeId");
            ...
            modelBuilder.Entity("Api.Core.Entities.ClienteImpuesto", b =>
                {
                    ...
                    b.HasOne("Api.Core.Entities.ErpMilongaTaxCode", "ErpMilongaTaxCode")
                        .WithMany()
                        .HasForeignKey("ErpMilongaTaxCodeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
